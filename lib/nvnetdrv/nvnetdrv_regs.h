...
#define NVREG_IRQMASK_THROUGHPUT (NVREG_IRQ_RX_ERROR | NVREG_IRQ_RX | NVREG_IRQ_RX_NOBUF | NVREG_IRQ_TX_ERROR | NVREG_IRQ_TX_OK | NVREG_IRQ_LINK | NVREG_IRQ_RX_FORCED)
